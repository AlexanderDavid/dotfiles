...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/AlexanderDavid/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/AlexanderDavid/dotfiles/master/.config/progs.csv"
...
sed -i "s/^$name:\(.*\):\/bin\/.*/$name:\1:\/usr\/bin\/fish/" /etc/passwd

# Set the git defaults
git config --global user.email "alex@alexday.me"
